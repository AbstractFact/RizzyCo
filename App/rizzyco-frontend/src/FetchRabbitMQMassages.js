...
import { actionCreators } from './RabbitMQ';
import rabbitMQMessageService from './messaging/rabbitMQMessageService';

export default class FetchRabbitMQMassages extends Component {
    constructor(props) {
        super(props);
        ...
        this.rabbitMQMessageService = new rabbitMQMessageService((msg) => {
            ...
            this.receiveTestMessage(msgtest);
        }
        );
    }
...
//     state => state.rabbitTestMessages,
